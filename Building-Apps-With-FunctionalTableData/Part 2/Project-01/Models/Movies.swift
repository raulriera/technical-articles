...
let toyStory: Movie = Movie(title: "Toy Story", summary: """
	...
	""", price: 14.99, url: URL(string: "https://itunes.apple.com/ca/movie/toy-story/id188703840")!)
...
let toyStory2: Movie = Movie(title: "Toy Story 2", summary: """
	...
	""", price: 24.99, url: URL(string: "https://itunes.apple.com/ca/movie/toy-story-2/id268793231")!)
...
let findingNemo: Movie = Movie(title: "Finding Nemo", summary: """
	...
	""", price: 9.99, url: URL(string: "https://itunes.apple.com/ca/movie/finding-nemo/id255295077")!)
